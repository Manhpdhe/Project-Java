 ...
 * @author CaoThuLuDau
 */
public class HeadManagerRevenueController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //Get TotalTicketSale of the latest 7 day periods
        Integer currentTTS = ticketCtx.getLatestTotalTicketSale("day", 7).getReturnObject();
        ...
        Integer previousTTS = ticketCtx.getLatestTotalTicketSale("day", 7, 7).getReturnObject();
        ...
        Map<String, Integer> monthRevenues = revenueCtx.getTotalRevenueYearMonth().getReturnObject();
