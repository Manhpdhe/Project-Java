    ...
    <body class="login-register-page">
        ...
        <div class="form-box login">
            ...
            <form action="${pageContext.request.contextPath}/login" method="POST">
                ...
                <div>
                    <c:forEach var="entry" items="${requestScope.obtainedParams}">
                        <c:forEach var="pValue" items="${entry.value}">
                            <input type="hidden" name="${entry.key}" value="${pValue}" />
                        </c:forEach>
                    </c:forEach>
                </div>
                <div class="input-box">
                ...
                <div class="login-register">
                    <p>Chưa có tài khoản? <a href="${pageContext.request.contextPath}/register" class="register-link">Đăng ký</a> ngay!</p>
                </div>
            </form>
