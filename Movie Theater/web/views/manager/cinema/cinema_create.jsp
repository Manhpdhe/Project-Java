...
<body>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="${pageContext.request.contextPath}/headmanage/cinemas?action=create"
                onsubmit="return checkInput();">
                <div class="name">
                    <div class="input-box">
                        <label>Tên rạp chiếu</label><br>
                        <input type="text" id="cinema-name" name="cinema-name" placeholder="Groovy Cineplex An Giang..."
                            required>
                    </div>
                </div>
                <br>
                <div class="input-box">
                    ...
                    <input type="text" id="cinema-location" name="cinema-location" placeholder="Tòa nhà Bicotex, Phú Nhuận..." required>
                </div>
                <br>
                <div>
