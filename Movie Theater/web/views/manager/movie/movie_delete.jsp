...
<html>
    ...
    <body>
        <form action="${pageContext.request.contextPath}/headmanage/movie/delete" method="POST">
        ...
        <button onclick="window.location.href='${pageContext.request.contextPath}/headmanage/movie'">No</button>
    </body>
</html>
